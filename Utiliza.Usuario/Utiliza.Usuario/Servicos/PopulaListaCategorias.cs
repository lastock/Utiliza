...
namespace Utiliza.Usuario.Servicos
{
    public class PopulaListaCategorias
    {
        ...
        public List<Categoria> Popula()
        {
            ...
            _categorias.Add(new Categoria { IdCategoria = 17, NomeCategoria = "Reparos", Ordem = 16, UrlLogo = "reparos.png" });
            _categorias.Add(new Categoria { IdCategoria = 18, NomeCategoria = "Saúde e Fitness", Ordem = 16, UrlLogo = "saudefitness.png" });
            _categorias.Add(new Categoria { IdCategoria = 19, NomeCategoria = "Serviços Públicos", Ordem = 16, UrlLogo = "publicos.png" });
            return _categorias;
        }
